...
$(document).ready(function() {
    ...
    function renderName(value, record, el) {
        return '<a href="index.php?fuse=clients&controller=userprofile&view=profilecontact&frmClientID=' + record.userId + '">' + record.clientName + '</a>';
    }
