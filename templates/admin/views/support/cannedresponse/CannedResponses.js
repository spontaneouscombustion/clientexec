...
$(document).ready(function() {
    ...
    cannedresponses.window = new RichHTML.window({
    	...
    	showSubmit: true,
    	title: clientexec.lang("Manage Canned Reply")
    });
    ...
    $('#delResponse').click(function () {
        ...
        RichHTML.msgBox(clientexec.lang('Are you sure you want to delete the selected response(s)'),
        {
            type:"confirm"
        }, function(result) {
