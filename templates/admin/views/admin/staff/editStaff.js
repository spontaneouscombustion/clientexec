$(document).ready(function() {
    $('#deleteStaffButton').click(function(e){
        ...
        RichHTML.msgBox(clientexec.lang("Are you sure you want to delete this account? WARNING: All support ticket information for this user will be replaced to generic Tech Support"), {
            type: 'confirm'
        },function(result) {
