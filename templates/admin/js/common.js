...
CE.prototype.parseResponse = function (response,display,msg) {
    ...
    message = response.message.replace(/</g, "&lt;").replace(/>/g, "&gt;").replace(/"/g, "&quot;");
...
clientexec.lang = function(phrase)
{
    if ((typeof language != "undefined") && (typeof language[phrase] != "undefined") && (language[phrase] != '')) {
        switch (clientexec.lang.arguments.length) {
            ...
            case 2:
                return _sprintf(language[phrase], clientexec.lang.arguments[1]);
            case 3:
                return _sprintf(language[phrase], clientexec.lang.arguments[1], clientexec.lang.arguments[2]);
            case 4:
                return _sprintf(language[phrase], clientexec.lang.arguments[1], clientexec.lang.arguments[2], clientexec.lang.arguments[3]);
        }
    ...
    switch (clientexec.lang.arguments.length) {
        case 1:
            return phrase;
        case 2:
            return _sprintf(phrase, clientexec.lang.arguments[1]);
        case 3:
            return _sprintf(phrase, clientexec.lang.arguments[1], clientexec.lang.arguments[2]);
        case 4:
            return _sprintf(phrase, clientexec.lang.arguments[1], clientexec.lang.arguments[2], clientexec.lang.arguments[3]);
    }
...
if ($.fn.dataTable) {
    $.extend( true, $.fn.dataTable.defaults, {
        ...
        autoWidth: false,
        language: {
            processing: clientexec.lang('Loading...'),
            emptyTable: clientexec.lang('No data available in table'),
            info: clientexec.lang('Showing % to % of % entries', '_START_', '_END_', '_TOTAL_'),
            infoEmpty: clientexec.lang('Showing 0 to 0 of 0 entries'),
            infoFiltered: '(' + clientexec.lang('filtered from % total entries', '_MAX_') + ')',
            infoPostFix:    "",
            thousands:      ",",
            lengthMenu:     clientexec.lang("Show % entries", '_MENU_'),
            loadingRecords: clientexec.lang("Loading..."),
            search:         clientexec.lang("Search:"),
            zeroRecords:    clientexec.lang("No matching records found"),
            paginate: {
                first:      clientexec.lang("<<"),
                last:       clientexec.lang(">>"),
                next:       clientexec.lang(">"),
                previous:   clientexec.lang("<")
            },
            aria: {
                sortAscending:  ": " + clientexec.lang("activate to sort column ascending"),
                sortDescending: ": " + clientexec.lang("activate to sort column descending")
            }
        },
    });
}