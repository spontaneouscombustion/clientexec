...
/**
     ...
     * @return void
     */
    public function deleteEmailAutoresponder($authorization, $address, $password, $autoresponder_id, string $contentType = self::contentTypes['deleteEmailAutoresponder'][0])
    {
        $this->deleteEmailAutoresponderWithHttpInfo($authorization, $address, $password, $autoresponder_id, $contentType);
    }
     ...
     */
    public function deleteEmailAutoresponderWithHttpInfo($authorization, $address, $password, $autoresponder_id, string $contentType = self::contentTypes['deleteEmailAutoresponder'][0])
    {
        $request = $this->deleteEmailAutoresponderRequest($authorization, $address, $password, $autoresponder_id, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteEmailAutoresponderAsync($authorization, $address, $password, $autoresponder_id, string $contentType = self::contentTypes['deleteEmailAutoresponder'][0])
    {
        return $this->deleteEmailAutoresponderAsyncWithHttpInfo($authorization, $address, $password, $autoresponder_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteEmailAutoresponderAsyncWithHttpInfo($authorization, $address, $password, $autoresponder_id, string $contentType = self::contentTypes['deleteEmailAutoresponder'][0])
    {
        $returnType = '';
        $request = $this->deleteEmailAutoresponderRequest($authorization, $address, $password, $autoresponder_id, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function deleteEmailAutoresponderRequest($authorization, $address, $password, $autoresponder_id, string $contentType = self::contentTypes['deleteEmailAutoresponder'][0])
    {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\AutorespondersFullListing' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\AutorespondersFullListing' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\ForwardersFullListing' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\ForwardersFullListing' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\EmailPublicIp' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\EmailPublicIp' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
     ...
     * @return void
     */
    public function updateEmailAutoresponder($authorization, $address, $password, $autoresponder_id, $update_autoresponder, string $contentType = self::contentTypes['updateEmailAutoresponder'][0])
    {
        $this->updateEmailAutoresponderWithHttpInfo($authorization, $address, $password, $autoresponder_id, $update_autoresponder, $contentType);
    }
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateEmailAutoresponderWithHttpInfo($authorization, $address, $password, $autoresponder_id, $update_autoresponder, string $contentType = self::contentTypes['updateEmailAutoresponder'][0])
    {
        $request = $this->updateEmailAutoresponderRequest($authorization, $address, $password, $autoresponder_id, $update_autoresponder, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateEmailAutoresponderAsync($authorization, $address, $password, $autoresponder_id, $update_autoresponder, string $contentType = self::contentTypes['updateEmailAutoresponder'][0])
    {
        return $this->updateEmailAutoresponderAsyncWithHttpInfo($authorization, $address, $password, $autoresponder_id, $update_autoresponder, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateEmailAutoresponderAsyncWithHttpInfo($authorization, $address, $password, $autoresponder_id, $update_autoresponder, string $contentType = self::contentTypes['updateEmailAutoresponder'][0])
    {
        $returnType = '';
        $request = $this->updateEmailAutoresponderRequest($authorization, $address, $password, $autoresponder_id, $update_autoresponder, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function updateEmailAutoresponderRequest($authorization, $address, $password, $autoresponder_id, $update_autoresponder, string $contentType = self::contentTypes['updateEmailAutoresponder'][0])
    {
