...
class UpdateRewriteChain implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'conds' => '\OpenAPI\Client\Model\RewriteChainCondsInner[]'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('conds', $data ?? [], null);
    }
    ...
    */
     ...
     * Gets conds
     *
     * @return \OpenAPI\Client\Model\RewriteChainCondsInner[]|null
     */
     ...
     * Sets conds
     *
     * @param \OpenAPI\Client\Model\RewriteChainCondsInner[]|null $conds conds
     *
     * @return self
     */
    ...
    {
        if (is_null($conds)) {
            throw new \InvalidArgumentException('non-nullable conds cannot be null');
        }
