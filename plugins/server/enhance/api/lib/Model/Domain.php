...
class Domain implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static array $openAPINullables = [
		...
		'cloudflare_token_friendly_name' => false
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('cloudflare_token_friendly_name', $data ?? [], null);
    }
    ...
    */
    ...
    {
        if (is_null($cloudflare_token_friendly_name)) {
            throw new \InvalidArgumentException('non-nullable cloudflare_token_friendly_name cannot be null');
        }
