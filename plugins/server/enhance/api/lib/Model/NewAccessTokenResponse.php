...
class NewAccessTokenResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('first_five', $data ?? [], null);
        $this->setIfExists('unencrypted_token', $data ?? [], null);
    }
    ...
    */
    ...
    {
        if (is_null($first_five)) {
            throw new \InvalidArgumentException('non-nullable first_five cannot be null');
        }
    ...
    {
        if (is_null($unencrypted_token)) {
            throw new \InvalidArgumentException('non-nullable unencrypted_token cannot be null');
        }
