...
<div id="wrapper" class="outline">
    ...
    <form id="messageform" action="#" style="display: none;">
        ...
        <div class="restartchatdiv" style="display:none;">
            <a href="#" class="restartchatbtn btn btn-lg form-control orange"><?php echo $this->user->lang('Start a New Conversation') ?></a>
        </div>
        <footer>
            <span class="typing_wrapper"></span>
            <?php if (!CE_Lib::hasAttribute("nobranding")) { ?>
            <div class="powered-by text-center col-xs-12"><?php echo $this->user->lang('Powered by') ?> <a href="//www.clientexec.com/?source=chat" target="_blank"><img class="brand-logo" src="templates/default/images/logo_text.png"  style="height: 20px;position: relative;top: 4px;"></a></div>
            <?php } ?>
        </footer>
    </form>
    ...
    <?php echo $this->user->lang('How may we assist you?') ?></label>
            <div class="form-group">
                <input type="text" id="fullname" name="fullname" placeholder="<?php echo $this->user->lang('Full Name') ?>" class="validate[required] form-control">
            </div>
            <div class="form-group">
                <input type="text" id="email" name="email" value="" placeholder="<?php echo $this->user->lang('E-mail') ?>" autocapitalize="none" class="validate[custom[email],required] form-control">
            </div>
            <div class="form-group">
                <input type="text" id="firstquestion" name="firstquestion" placeholder="<?php echo $this->user->lang('Your Question') ?>" class="validate[required] form-control">
            </div>
            <a href="#" class="btn btn-lg form-control orange startchattingbtn" target="_blank"><?php echo $this->user->lang('Start Chatting') ?></a>
        </div>
        <?php if (!CE_Lib::hasAttribute("nobranding")) { ?>
        <div id="powered-by" class="powered-by text-center col-xs-12">
            <?php echo $this->user->lang('Powered by') ?> <a href="//www.clientexec.com/?source=chat" target="_blank"><img class="brand-logo" src="templates/default/images/logo_text.png" style="height: 20px;"></a>
        </div>
        <?php } ?>
    </form>
